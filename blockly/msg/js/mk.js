...
Blockly.Msg.ARD_SERIAL_AVAILABLE = "available";  // untranslated
Blockly.Msg.ARD_SERIAL_AVAILABLE_TIP = "Get the number of bytes (characters) available for reading from the serial port.";  // untranslated
Blockly.Msg.ARD_SERIAL_AVAILABLE_WARN = "A setup block for %1 must be added to the workspace to use this block!";  // untranslated
...
Blockly.Msg.ARD_SERIAL_READ_TIP = "Reads the first byte of incoming serial data available (or -1 if no data is available)";  // untranslated
Blockly.Msg.ARD_SERIAL_READ_WARN = "A setup block for %1 must be added to the workspace to use this block!";  // untranslated
